...
export const Route = createFileRoute("/_app/staff" as never)({
  head: () => ({
    meta: [
  ...
  component: () => (
    <ScaffoldPage
      ...
      sections={[
        { title: "Headcount", desc: "By department", rows: [
          { label: "Fashion", v: "24" },
        ...
        { title: "Attendance", desc: "Today", rows: [
          { label: "Present", v: "138 / 142" },
          { label: "On leave", v: "3" },
          { label: "Overtime", v: "6" },
        ]},
        { title: "Top Managers", desc: "By department revenue", rows: [
