...
export const Route = createFileRoute("/_app/analytics" as never)({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cross-domain analytics across revenue, customers, and operations." },
    ],
  }),
  component: () => (
    <ScaffoldPage
